 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Stephen S. Cha");
		  toPrint += p1.toString("scha35");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Devon Cooper");
		  toPrint += p2.toString("dcooper41");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Youssif Hassanein");
		  toPrint += p3.toString("yhassanein3");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Matthew Henderson");
                  toPrint += p4.toString("gth681b");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("N/A");
                  toPrint += p5.toString("N/A");
